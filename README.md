...
Cybersecurity graduate with hands-on SOC simulation experience in log analysis, intrusion detection, vulnerability assessment, and network defense using Wazuh, Suricata, Wireshark, and Nessus.
...
### Systems
Windows 10/11 • Linux (Ubuntu, Kali) • VirtualBox
